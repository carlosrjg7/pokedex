...
const Error = ({seterror}) => {
    ...
    return (
        <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded absolute w-4/12 h-14 z-10 -mt-10" role="alert" 
        >
            <strong className="font-bold">Error Pokedex, </strong>
            <span className="block sm:inline">  el pokemon no existe!</span>
